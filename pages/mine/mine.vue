	...
	<view class="profile-main" v-if="isLogin">
		...
		<view class="profile-info">
			<view class="image-wrap">
				<u-avatar :text="profileData.name[0]" fontSize="25" randomBgColor size="50"></u-avatar>
				<!-- <u-avatar :src="profileData.avatarUrl" fontSize="28" size="50"></u-avatar> -->
			</view>
		...
		<view class="profile-other">
			<view class="profile-other">
				<view class="profile-item wrap"><text>职位</text><text>{{ profileData.position }}</text></view>
				<view class="profile-item wrap"><text>电话</text><text>{{ profileData.phone }}</text></view>
				<view class="profile-item wrap"><text>教育经历</text><text>{{ profileData.education }}</text></view>
				<view class="profile-item wrap"><text>年龄</text><text>{{ profileData.age }}</text></view>
				<view class="profile-item wrap"><text>地址</text><text>{{ profileData.address }}</text></view>
			</view>
...
.test-plan {
	...
	.plan-item-wrap {
		...
		.plan-item {
			...
			display: flex;
			text-align: center;
			border-bottom: 1rpx solid #4e00c9;
